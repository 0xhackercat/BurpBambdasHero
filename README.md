...
[PortSwigger 官方的 Bambda 專案](https://github.com/PortSwigger/bambdas) 已經提供一些經典的 Bambda filter 範例，但在實際滲透測試或自動化分析中，還有很多情境與需求是尚未涵蓋的。

因此，我建立了這個 **BurpBambdasHero** 專案，分享官方未收錄的 Bambda 腳本，這些腳本可以協助：
